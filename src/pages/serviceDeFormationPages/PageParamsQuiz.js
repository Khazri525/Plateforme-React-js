...
<a href="#" className="btn btn-success btn-sm " data-toggle="modal" data-target="#z" style={{marginRight:"1cm"}}> +créer un Test</a>  
...
<div className="card card-success" style={{marginLeft:"1cm",marginRight:"1cm"}}>
    ...
    <div className="card-header">
      ...
      <h3 className="card-title">Les Paramétres du Test</h3>
      <div className="card-tools">
